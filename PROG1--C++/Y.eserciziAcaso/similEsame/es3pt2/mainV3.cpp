...
// ============================================================================
bool visita(bool** A, int N, int source);

// ============================================================================
// IMPLEMENTAZIONE DELLA FUNZIONE VISITA
// ============================================================================
bool visita(bool** A, int N, int source, int target) {
    if (source == target) {
        return true; // Se sorgente e destinazione coincidono, è banalmente vero
    }
    ...
    while (!s.isEmpty()) {
        ...
        if (curr == target) {
            trovato = true;
            break; // Abbiamo trovato la destinazione, fermiamo il ciclo
        }
    ...
    // Deallocazione dell'array prima di uscire dalla funzione
    delete[] visited;
